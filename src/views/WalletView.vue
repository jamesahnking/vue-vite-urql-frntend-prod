...
export default defineComponent({
  ...
  setup() {
    ...
    mounted() {
        console.log("WalletView component mounted");
    },
...
<template>
  <div class="surface-section px-4 py-6 md:px-6 lg:px-8">
    <!-- Grid 1 Header Mod-->
    <div class="grid bg-red-100 mb-6 align-items-center">
      <!-- c1 -->
      ...
      <div class="col-12 lg:col-10 lg:px-5">
        ...
        >
          ...
          <div class="text-center mb-2">
            ...
            />
            <span class="block text-600 line-height-3"> {{ data?.project.data.attributes.descimage01
            }}</span>
          </div>
