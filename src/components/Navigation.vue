...
<template>
  <div
    class="bg-gray-900 py-3 px-6 shadow-2 flex align-items-center justify-content-between relative lg:static"
  ...
  >
    ...
    <router-link to="/" class="no-underline">
      <img
        v-bind:src="
          data?.navigation.data.attributes.jaklogowhite.data.attributes.url
        "
        alt="Image"
        height="40"
        class="mr-0 lg:mr-6"
    ...
    >
      ...
      >
        <li>
          ...
          <span class="no-underline text-sm text-100 lg:px-2"
            ><strong>James Ahn-King</strong> - Full-Stack Developer</span
          >
        </li>
        ...
        <li class="lg:relative">
          <a
            v-ripple
            class="flex px-6 p-3 lg:px-3 lg:py-2 align-items-center text-0 hover:text-900 hover:surface-100 font-medium border-round cursor-pointer transition-colors transition-duration-150 p-ripple"
            v-styleclass="{
              selector: '@next',
              enterClass: 'hidden',
              ...
              <li>
                ...
                >
                  ...
                  <span class="font-medium">{{
                    data?.navigation.data.attributes.navitem08
                  }}</span>
                </a>
              </li>
            </router-link>
            <router-link to="/DevSite" class="no-underline">
              <li class="relative">
                ...
                >
                  <i class="pi pi-chevron-right mr-2 text-xs"></i>
                  <span class="font-medium">{{
                    data?.navigation.data.attributes.navitem01
                  }}</span>
                </a>
              </li>
            </router-link>
            <router-link to="/NftMarketPlace" class="no-underline">
              <li class="relative">
                ...
                >
                  <i class="pi pi-chevron-right mr-2 text-xs"></i>
                  <span class="font-medium">{{
                    data?.navigation.data.attributes.navitem02
                  }}</span>
                </a>
              </li>
            </router-link>
            ...
            <router-link to="/MultiSigWallet" class="no-underline">
              <li class="relative">
                ...
                >
                  <i class="pi pi-chevron-right mr-2 text-xs"></i>
                  <span class="font-medium">{{
                    data?.navigation.data.attributes.navitem03
                  }}</span>
                </a>
              </li>
            </router-link>
            <router-link to="/Adex" class="no-underline">
              <li class="relative">
                ...
                >
                  <i class="pi pi-chevron-right mr-2 text-xs"></i>
                  <span class="font-medium">{{
                    data?.navigation.data.attributes.navitem04
                  }}</span>
                </a>
              </li>
            </router-link>
            <router-link to="/PillarsAndRings" class="no-underline">
              <li class="relative">
                ...
                >
                  <i class="pi pi-chevron-right mr-2 text-xs"></i>
                  <span class="font-medium">{{
                    data?.navigation.data.attributes.navitem05
                  }}</span>
                </a>
              </li>
            </router-link>
